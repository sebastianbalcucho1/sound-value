...
introComponents = [mensaje_intro, key_resp]
...
_key_resp_2_allKeys = []
# keep track of which components have finished
intro_2Components = [mensaje_intro_2, key_resp_2]
...
_key_resp_3_allKeys = []
# keep track of which components have finished
intro_pruebaComponents = [textbox_prueba, key_resp_3]
...
_key_resp_4_allKeys = []
# keep track of which components have finished
intro_experimentoComponents = [textbox_prueba_2, key_resp_4]
...
_key_resp_5_allKeys = []
# keep track of which components have finished
subasta1Components = [text_subasta1, key_resp_5]
...
_key_resp_6_allKeys = []
# keep track of which components have finished
subasta2Components = [text_subasta2, key_resp_6]
...
_key_resp_7_allKeys = []
# keep track of which components have finished
pago1Components = [text, key_resp_7]
...
_key_resp_8_allKeys = []
# keep track of which components have finished
pago2Components = [text_4, key_resp_8]
...
_key_resp_9_allKeys = []
# keep track of which components have finished
productoComponents = [text_producto, image, key_resp_9]
...
# keep track of which components have finished
pago3Components = [texto_final, key_resp_10]
...
# keep track of which components have finished
intro_encuestaComponents = [text_2, key_resp_11]
