...
expName = 'piloto2'  # from the Builder filename that created this script
expInfo = {'participant': 'INGRESE SU CEDULA AQUÍ'}
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\LENOVO\\OneDrive\\Desktop\\sonico-master\\piloto2.py',
